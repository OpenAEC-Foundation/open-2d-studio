...
import { boundsRegistry } from '../registry/BoundsRegistry';
 ...
 */
export function annotationScaleFactor(drawingScale?: number): number {
 ...
 * @param drawingScale - Optional drawing scale for text annotation scaling
 */
export function getShapeBounds(shape: Shape, drawingScale?: number, _gridlineExtension?: number | Map<string, any>, _blockDefinitions?: Map<string, any>): ShapeBounds | null {
  switch (shape.type) {
    case 'line':
      return {
